...
metadate: "hide"
date : 2023-10-12 18:00:00 +0900
categories: [ ML/DL ]
image: "/assets/images/activation-function.png" 
visit: "https://github.com/All4Nothing"
---
## Activation Funciton 활성화 함수

예측함수에서 Activation(활성화 함수)를 사용하는 이유는 다음과 같다.
...
- logistic으로도 불리는 s자 형태를 띄는 함수
    ...
    ![Left : **σ**(x), Right : **σ’(x)**](../img/sigmoid.png)
...
- tanh 또는 hyperbolic tangent 함수로 쌍곡선 함수이다. 시그모이드 변형을 이용해 사용가능하다.
    ...
    ![Left : **σ**(x), Right : **σ’(x)**](../img/tanh.png)
...
- Rectified Linear Unit  개선 선형 함수.
    ...
    ![Left : **σ**(x), Right : **σ’(x)**](../img/relu.png)
...
- 단점
    - Dying ReLU
        - 입력값이 0 또는 음수일 때, gradient 값은 0이된다. → 학습을 하지못한다.
...
- Leaky ReLU, Parametric ReLU (PReLU), ELU, Swish, Softplus, Softsign, Thresholded ReLU, Maxout 등